...
-   display a list of departments and the average salary (calculated
    automatically) for these departments,

-   display a list of employees in the departments with an indication of the
    salary for each employee and a search field to search for employees born on
    a certain date or in the period between dates,
...
-   The user must be able to take from database a list of departments and the
    average salary (calculated automatically) for these departments by
    displaying them on the screen

-   The user must be able to display a list of employees in the departments with
    an indication of the salary for each employee and a search field to search
    for employees born on a certain date or in the period between dates
...
First_step will be running on a local server that has Django, Python 3.9 and
...
-   The web application use the web service for storing data and reading them
    from the database.
...
-   We assume the user has the necessary knowledge and skills to run a local
    server

-   We depend on the correct operation between Python+Django and the local
    server
...
This page will allow a user to add a new employee to the selected department.

![](7.png)

**Edit Employee page**

This page will allow a user to make changes to the data of an employee of the
selected department.
...
This page will allow a user to delete an employee of the selected department.
...
-   The user must be able to interact with the software to determine the dataset
    he wishes to analyze
...
Then the application will display a red comment at the bottom of the login page
that  
says “username or password incorrect.
...
Then the app will redirect the user to the List of Employees of chosen
Department
...
And the user selects by clicking on the Add an Employee button
...
And the user selects by clicking on the Delete button
...
The user has entered employee's date of birth or a specified period and selects
...
-   The user’s login information should be secure enough so that anyone except
    for the developers will know that user’s username/email and password

-   When the user types his or her password to login, it should be hidden

-   The system should be secure enough so that the user’s personal information
    will not be disclosed to unauthorized users

-   The system should be secure enough to prevent the corruption of data from
    unauthorized users

-   The system should be secure enough to protect against denial-of-service
    attacks
...
-   The application must be reliable enough so that when users perform normal  
    functions, the system does not fail

### 4.3.3 Usability

-   The application must be easy enough to learn so that users know how to use
    the  
    product entirely on their first try

### 4.3.4 Flexibility

-   The application must be flexible enough to support Google Chrome and Firefox
    browsers
